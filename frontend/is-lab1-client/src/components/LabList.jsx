...
export default function LabList() {
  ...
  const fetch = useCallback(() => {
    setLoading(true)
    labApi.list(paginationModel.page, paginationModel.pageSize).then(r => {
  ...
  const columns = [
    ...
    { field: 'description', headerName: 'Description', minWidth: 200, flex: 1, valueGetter: description => description || '-' },
    { field: 'difficulty', headerName: 'Difficulty', width: 140, valueGetter: difficulty => difficulty || '-' },
    { field: 'minimalPoint', headerName: 'Minimal Point', type: 'number', width: 140, valueGetter: minimalPoint => minimalPoint || '-' },
    { field: 'maximumPoint', headerName: 'Maximum Point', type: 'number', width: 150, valueGetter: maximumPoint => maximumPoint || '-' },
    { field: 'tunedInWorks', headerName: 'Tuned In Works', type: 'number', width: 150, valueGetter: tunedInWorks => tunedInWorks || '-' },
    {
      field: 'creationDate',
  ...
  return (
    <div>
      <Grid container spacing={2} alignItems="center" sx={{ mb: 2 }}>
        ...
        <Grid item>
          <Button variant="outlined" onClick={() => { setPaginationModel(prev => ({ ...prev, page: 0 })) }}>Apply</Button>
        </Grid>
